...
//  Algorithm: https://e-maxx.ru/algo/prefix_function
//  (на основе поиска подстроки в строке)
int isPrefixes(const char* pattern, const char* text) {
...
int main(int argc, char* argv[]) {
    if (argc == 3) {
        printf("%s\n", (isPrefixes(argv[1], argv[2]) ? "yes" : "no"));
    }
    return 0;
}
